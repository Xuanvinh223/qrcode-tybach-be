...
func migration() {
	DB.AutoMigrate(&entities.SysUser{})
	DB.AutoMigrate(&entities.SysRole{})
	DB.AutoMigrate(&entities.SysMenu{})
	DB.AutoMigrate(&entities.SysUserRole{})
	DB.AutoMigrate(&entities.SysRoleMenu{})
	DB.AutoMigrate(&entities.SysCasbin{})
}
